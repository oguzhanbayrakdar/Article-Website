        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ArticleRef = table.Column<Guid>(nullable: false),
                    ArticleId = table.Column<Guid>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ArticleViewsCounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ArticleViewsCounts_Articles_ArticleId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MainCommentId = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ArticleViewsCounts_ArticleId",
                table: "ArticleViewsCounts",
                column: "ArticleId");
